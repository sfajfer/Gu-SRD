    ...
    const keywordsData = [
        ...
        },
        {
            ...
            desc: (
                <>
                    <p className="rule-text">
                        [Steed] Gu are typically larger than regular Gu and can be ridden while outside your aperture. They also come with a statblock, unlike most other Gu, and count as a creature since they are capable of thinking and fighting beyond just activating themselves. That being said, they do not have regular anatomy and are completely unaffected by injuries. It is impossible to sever a [Steed] Gu’s limbs until it is dead, and it has immunity to the <Link to="/conditions#bleeding">bleeding</Link>, <Link to="/conditions#blinded">blinded</Link> and <Link to="/conditions#deafened">deafened</Link> conditions. Unless a poison specifically states it works on Gu, Gu are immune to the poisoned condition.
                    </p>
                    <p className="rule-text">
