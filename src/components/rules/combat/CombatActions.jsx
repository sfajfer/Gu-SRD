    ...
    return (
        <div className="gu-shell">
            ...
            <main className="gu-main" style={{ padding: '20px' }}>
                ...
                <p className="rule-text">
                    As a Combat Action, a grappled creature can attempt to break free, making an opposed <Link className="rule-link" to="/rules/skills#athletics">Athletics</Link> skill test against the grappler. On a success, they break free.
                </p>
                ...
                <p className="rule-text">
                    You can choose to hold your Combat Action, specifying an action and a trigger for it to occur. When the trigger happens, you may use a Reaction to take that Combat Action. If you are reacting to an opponent’s actions, you must make an opposed skill test to see whose action occurs first, with the skill in question being <Link className="rule-link" to="/rules/skills#close-combat">Close Combat</Link> if within 2 meters of each other, or <Link className="rule-link" to="/rules/skills#ranged-attack">Ranged Attack</Link> if not. If you hold the Activate Gu action, you may only specify a single activation.
                </p>
                <p className="rule-text">
