    ...
    return (
        <div className="gu-shell">
            ...
            <main className="gu-main" style={{ padding: '20px' }}>
                ...
                <p className="rule-text">
                    When a creature is the <em>projectile</em> and an object the <em>defender</em>, both parties take force damage equal to either half the creature's Fortitude Attribute. The creature cannot take more damage from the collision than the object has hit points, however. If the object is destroyed or is more than a single size smaller than the creature, the creature continues as if it had not struck the object, triggering any subsequent collisions like normal. Otherwise, it stops in the closest square adjacent to the object.
                </p>
                <p className="rule-text">
                    <em>Example: Shang Liu is thrown into a centimeter-thick wooden wall, causing a collision. Shang Liu's Fortitude Attribute is 30, so 15 force damage will be dealt to both him and the wall. Wood has a DT of 2; walls have 5 hit points for every centimeter they are thick, multiplied by the DT of 2 for 10 hit points. Immediately, Shang Liu doesn't take the full 15 damage since the wall's hit points are lower, so he only takes 10 force damage from the collision. The 15 damage dealt to the wall is more than enough damage to destroy this section, so Shang Liu crashes through it and lands prone on the other side.</em>
                </p>
                <p className="rule-text">
