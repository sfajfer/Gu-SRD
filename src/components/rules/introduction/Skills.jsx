    ...
    return (
        <div className="gu-shell">
            ...
            <main className="gu-main" style={{ padding: '20px' }}>
                ...
                <p className="rule-subheading">Close Combat (1/2 Agi + 1/2 Cog)</p>
                <p className="rule-text">
                ...
                <p className="rule-subheading">Dodge (Agi)</p>
                <p className="rule-text">
                ...
                <p className="rule-subheading">Flying (Agi)</p>
                <p className="rule-text">
                ...
                <p className="rule-subheading">Refinement (Wis)</p>
                <p className="rule-text">
                ...
                <p className="rule-subheading">Deduction (Cog)</p>
                <p className="rule-text">
                ...
                <p className="rule-subheading">Persuasion (Att)</p>
                <p className="rule-text">
                ...
                <p className="rule-subheading">Insight (Wis)</p>
                <p className="rule-text">
                ...
                <p className="rule-subheading">Awareness (Wis)</p>
                <p className="rule-text">
                ...
                <p className="rule-subheading">Cultivation (Wis)</p>
                <p className="rule-text">
                ...
                <p className="rule-subheading">Knowledge (Cog)</p>
                <p className="rule-text">
