...
const KEYWORD_DESCRIPTIONS = {
  ...
  'Investigative': 'Most [Investigative] Gu are divinations that are used to detect your surroundings for creatures, Gu, or even specific objects. The keyword will always be followed by the sense it augments; there are [Investigative: Sight] Gu, [Investigative: Hearing] Gu, [Investigative: Smell] Gu, and [Investigative: Detect] Gu. Sight, hearing, and smell are self explanatory, and you cannot see or hear through sight or hearing [Investigative] Gu if you have the blinded or the deafened condition, respectively. Detect Gu transmit the locations of whatever Gu, objects, or creatures the Gu is meant to detect directly into your mind, and do not require the use of any of your senses. If you use an [Investigative] Gu besides sight while blinded to detect the location of a creature, the +40 penalty to Close Combat and Ranged Attack skill tests from the blinded condition is reduced to a +10 penalty. Stealthing effects like invisibility and illusions will specify one or more of the following: \n •	Invisible - Cannot be seen normally or by [Investigative: Sight] Gu. Also a condition that can be applied to creatures and objects. \n •	Inaudible - Cannot be heard normally or by [Investigative: Hearing] Gu. \n •	Odorless - Cannot be smelled normally or by [Investigative: Smell] Gu. \n •	Undetectable - Cannot be detected by [Investigative: Detect] Gu. \n If the [Investigative] Gu is of high enough rank, it ignores the stealthing effect entirely. Unless otherwise specified, [Investigative] Gu ignore stealthing effects of a lower rank.',
  ...
  'Size': 'If size is not listed, the Gu is the most common size, [Tiny]; that of a large insect. If the Gu is [Small] it is the size of a child, and [Medium] is the size of a man. [Large] Gu take up 4 squares when outside of your aperture, and [Huge] Gu take up 9 or more squares. Creatures and objects also have a size. Attack rolls against a target have a penalty or bonus dependent on their size: {Tiny: +40, Small: +20, Medium: 0, Large: -20, Huge: -40}',
